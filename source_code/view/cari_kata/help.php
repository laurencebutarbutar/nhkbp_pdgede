...
<html lang="en">
	...
	<!-- Start Account Page -->
		<div class="container">		
		    ...
		    <div class="row" style="margin-top: 5px;">
			    <div class="col-sm-8 col-sm-offset-2">
					<img class="img-responsive" src="../../assets/img/cari_kata/howToPlayCariKata.jpg">
				    ...
				    <div class="row" style="margin-top: 5px;">
					    <div class="col-sm-8 col-sm-offset-2">
				    		...
				    		<div class="col-xs-6 col-sm-6 col-lg-6"><a href="../../view/cari_kata/highScore.php"><img class="img-responsive" src="../../assets/img/cari_kata/highScoreCariKata.png" align="left"></a></div>
			    		</div>
		    		</div>
			    </div>   	
			</div>			 
