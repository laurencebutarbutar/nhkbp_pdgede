...
if (!mysqli_connect_errno()){
    ...
    $selectUsersTTSActivities = mysqli_query($con, "SELECT 1 FROM t_rel_users_activities where t_users_detail_id = '".$usersDetailId."' and t_activities_id = 1");

    if (mysqli_num_rows($selectUsersTTSActivities) > 0){
