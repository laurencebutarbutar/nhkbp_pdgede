...
$content = $_SESSION['questCariKata'];
$answer = $_SESSION['answerCariKata'];
$additional = $_SESSION['additionalCariKata'];
//validasi back force
...
//validasi skip page
if($validPlay !== true |$content === null || $answer === null){
...
$gameNumber=intval($_SESSION['game_numberCariKata']);
...
if ($answer!=null||$answer!=NULL||$answer!=''||$answer!=""):
    $answer = explode ("^", $answer);
endif;

//game number
$_SESSION['game_numberCariKata'] = $gameNumber;
?>
...
<html lang="en">
    ...
    <body style="background-color: #2d2c41; color: black;">
        ...
        <div class="container">     
            ...
            <form action='../../services/cari_kata/prosesAnswer.php' method='post' enctype='multipart/form-data' autocomplete='off'>
            <div class="row" style="margin-top: 5px;">         
                <div class="col-sm-8 col-sm-offset-2">
                    <!-- <div class="table-responsive"> -->
                    <?php
                        echo "<table style='width:100%; height:auto'>";
                            $bgBox = "dark_brown_board.png";
                            $bgCol=null;
                            for ($i=0; $i<count($obj); $i++){
                                echo "<tr>";
                                for ($j=0; $j<count($obj[$i]); $j++){                                    
                                    if ($obj[$i][$j]!="#"&&$obj[$i][$j]!="~"):
                                        echo "<td valign='middle' align='center' style='background:url(../../assets/img/cari_kata/res/".$bgBox.")'>";
                                    else :
                                        echo "<td valign='middle' align='center' style='border-collapse: collapse; margin 0; padding 0 0 0 0'>";
                                    endif;                                    
                                    if ($bgBox=="dark_brown_board.png"):
                                        $bgCol=null;
                                        $bgCol[]="185";
                                        $bgCol[]="145";
                                        $bgCol[]="120";
                                    ...
                                    if ($obj[$i][$j]=="#"):
                                        echo '<img src="../../assets/img/cari_kata/borderCariKata.png" style="width:100%; height:auto;">';
                                    elseif ($obj[$i][$j]=="~"):
                                        echo '<img src="../../assets/img/cari_kata/borderCariKata.png" style="width:100%; height:auto;">';
                                    else:
                                        echo '<img src="../../assets/class/getText.php?tx='.strtoupper($obj[$i][$j]).'&sz=20&bg1='.$bgCol[0].'&bg2='.$bgCol[1].'&bg3='.$bgCol[2].'&tx1=0&tx2=0&tx3=0" width="60%"/>';
                                        // echo strtoupper($obj[$i][$j]);
                                    endif;                                    
                                    echo "</td>";                                    
                                    if ($bgBox=="dark_brown_board.png"):
                                        $bgBox = "light_brown_board.png";
                                    elseif ($bgBox=="light_brown_board.png"):
                                        $bgBox = "dark_brown_board.png";
                                    endif;                                      
                                }
                                echo "<td>";
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="row" style="margin-top: 5px;">
                        <div class="col-sm-12">
                            ...
                            <p align="center" style="font-size: 18px; font-weight: bold; color: white; text-decoration: underline;"><i class="fa fa-pencil">&nbsp;</i>Answer</p>
                            <p align="center" style="font-size: 18px; font-weight: bold; color: white;"><i class="fa fa-question">&nbsp;</i>Clue For This Level : <?php echo $additional?></p>
                            <table align="center" style="border-collapse: collapse; background-color:#712c24; font-family: 'Press Start 2P', cursive; font-size: 14px; text-align:center; color: white">
                           <?php
                                $noAnswer = 1;
                                for ($i=0; $i<count($answer)-1; $i++){                                    
                                    echo '<tr>'; 
                                    echo "<td style = 'border: 3px solid black; width:15%; '>".$noAnswer."."."</td >";                                     
                                    echo '<td style = "border: 3px solid black;">';                                                         
                                    echo "<input type='text' name='ansCariKata[]' style='background-color:#712c24; width:100%; height:40px;font-size:15px; border:none; text-transform:uppercase;text-align:center; color:white' />";
                                    echo '</td>';                                    
                                    echo '</tr>';
                                    $noAnswer ++;                                    
                                }
