...
if(isset($_SESSION['highScoreTTSAccount'])){
  $highScoreTTS = $_SESSION['highScoreTTSAccount'];
}else{
  $highScoreTTS = 0;
}

if(isset($_SESSION['highScoreCariKataAccount'])){
  $highScoreCariKata = $_SESSION['highScoreCariKataAccount'];
}else{
  $highScoreCariKata = 0;
}

if(isset($_SESSION['teamMemberName'])){
  $teamMemberName = $_SESSION['teamMemberName'];
}else{
  $teamMemberName = [];
}

if(isset($_SESSION['teamMemberPhone'])){
  $teamMemberPhone = $_SESSION['teamMemberPhone'];
}else{
  $teamMemberPhone = [];
}

if(isset($_SESSION['teamCreated'])){
  $teamCreated = $_SESSION['teamCreated'];
}else{
  $teamCreated = [];
}

if(isset($_SESSION['medSosName'])){
  $medSosName = $_SESSION['medSosName'];
}else{
  $medSosName = [];
}

if(isset($_SESSION['medSosId'])){
  $medSosId = $_SESSION['medSosId'];
}else{
  $medSosId = [];
}

if(isset($_SESSION['successUpdateAccount'])){
  $successUpdateAccount = $_SESSION['successUpdateAccount'];
}else{
  $successUpdateAccount = 0;
}

if(isset($_SESSION['messageUpdateAccount'])){
  $messageUpdateAccount = $_SESSION['messageUpdateAccount'];
}else{
  $messageUpdateAccount = 0;
}
