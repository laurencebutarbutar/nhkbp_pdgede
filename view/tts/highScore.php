			    ...
			    <div class="col-sm-8 col-sm-offset-2">
				    <div class="row" style="margin-top: 5px;">
					    <div class="col-sm-8 col-sm-offset-2">
				    		...
				    		<div class="col-xs-6 col-sm-6 col-lg-6"><a href="../../tts"><img class="img-responsive" src="../../assets/img/tts/homeTTS.png"" align="left"></a></div>
			    		</div>
		    		</div>
			    </div>   	
			</div>			 
