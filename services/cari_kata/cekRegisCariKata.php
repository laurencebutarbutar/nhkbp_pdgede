...
$activitiesId = 2; //Activities id - Cari Kata
$appsId = 13; //Apps Id - Cari Kata
            ...
            if (mysqli_num_rows($selectAppsId) > 0){
                ...
                if (mysqli_num_rows($selectEventsId) > 0){
                    ...
                    if (mysqli_num_rows($selectHighScoreUser) > 0){
                        ...
                        endwhile;
                        $_SESSION['highScoreUserCariKata'] = $scoreHighUsers[0];
                    }
                    else{
                        $_SESSION['highScoreUserCariKata'] = 0;
                    } 
                    
                    $_SESSION['loginCariKata'] = 1;
                    $_SESSION['userIdLoginCariKata'] = $usersIdLogin;
                    $_SESSION['appsIdCariKata'] = $appsId;
