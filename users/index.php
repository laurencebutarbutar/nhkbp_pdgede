...
//status Regis
if(isset($_SESSION['successRegisActivities'])){
	$successRegisActivities = $_SESSION['successRegisActivities'];
}else{
	$successRegisActivities = 0;
}

//message Regis
if(isset($_SESSION['messageRegisActivities'])){
	$messageRegisActivities = $_SESSION['messageRegisActivities'];
}else{
	$messageRegisActivities = 0;
}
          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="/nhkbp-pdgede/users" style="color: #b63b4d">Profile</a></li>
